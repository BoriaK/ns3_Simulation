 ...
 */
#ifndef CUSTOME_ON_OFF_HELPER_H
#define CUSTOME_ON_OFF_HELPER_H
...
public:
   ...
   *        to.
   */
  CustomeOnOffHelper (std::string protocol, Address address);
